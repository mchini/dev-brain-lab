...
{{< figure src="1f-decorr-nn.png" caption="Using spiking neural networks, we show that a shift towards inhibition leads to
decorrelation of spiking activity From [Chini et al., 2022](https://elifesciences.org/articles/78811) " >}}
{{< figure src="ripple.png" caption="In [Pochinok et al., 2024](https://www.nature.com/articles/s41467-024-44983-z),
we show that the shift in E-I ratio drives the emergence of hippocampal ripples" >}}
