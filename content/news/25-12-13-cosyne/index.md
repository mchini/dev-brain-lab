---
title: CON²PHYS is live — and we’re bringing it to COSYNE (with the IBL!) 🚀
date: 2025-12-15
image:
  preview_only: true
profile: false
...
## The hackathon
Hackathon details are live [here](https://pre-cosyne-brainhack.github.io/hackathon2026/).

Format-wise, it’s the same spirit as the [Bernstein CON²PHYS hackathon](https://www.chinilab.com/news/25-07-30-bernstein-2025/), but this time
the event will unfold across two days of hacking, and there will be multiple Research Software Engineers on how to improve consistency 
scattered throughout the event. Here is the [schedule](https://pre-cosyne-brainhack.github.io/hackathon2026/schedule/).

The key difference: **the questions will be different** from Bernstein.
...
## If you’re considering a full CON²PHYS submission
And if you’re gutted you can’t make it to the hackathon, don’t overthink it — skip straight to the next step and start working on the full project anyway.

The [full project]((https://mchini.github.io/con2phys/)) is open now, and substantive submissions will be eligible for co-authorship.  
